...
function EditProduct() {
    ...
    {
        React.useEffect(() => {
            fetch(`https://backend64212.herokuapp.com/Product/single_product/${productId}`).then((result) => {
    ...
    async function submitEditForm(e) {
        ...
        // let data = { formdata }
        let result = await fetch(`https://backend64212.herokuapp.com/Product/${productId}`, {
            method: "PATCH",
            body: formdata
        })
        let output = ""
