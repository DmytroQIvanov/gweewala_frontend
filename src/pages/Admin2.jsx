...
function Admin2() {
    ...
    {
        useEffect(() => {
            fetch(`${serverUrl}/order/pending`).then((result) => {
                result.json().then((resp) => {
    ...
    {
        useEffect(() => {
            fetch(`${serverUrl}/order/delivered`).then((result) => {
                result.json().then((resp) => {
    ...
    {
        useEffect(() => {
            fetch(`${serverUrl}/auth/allUsers`).then((result) => {
                result.json().then((resp) => {
                    setAllUsers(resp)
                    setUserLoading(true)
                    // dispatch(HomepageDataSave(resp))
    ...
    {
        useEffect(() => {
            fetch(`${serverUrl}/auth/allAdmin`).then((result) => {
                result.json().then((resp) => {
                    setAllAdmin(resp)
